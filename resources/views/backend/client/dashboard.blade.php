            ...
            <div class="col-md-6">
                <div class="dash_blog">
                    <div class="dash_blog_inner">
                        ...
                        <ul class="msg_list">
                            <li>
                                <span><img src="{{ asset('assets/backend/client') }}/images/layout_img/msg2.png" class="img-responsive" alt="#" /></span>
                                <span>
                            ...
                            <li>
                                <span><img src="{{ asset('assets/backend/client') }}/images/layout_img/msg3.png" class="img-responsive" alt="#" /></span>
                                <span>
